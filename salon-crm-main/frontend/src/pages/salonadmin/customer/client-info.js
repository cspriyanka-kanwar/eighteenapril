...
function PaymentHistory({ client }) {
  ...
  const tabItems = [
    ...
    { key: "Merge_client", label: "Merge Client", content: <MergeInfo client={client} />  },
    { 
      key: "appointments", 
    ...
    { key: "package sale", label: "Package Sale", content: <p>Package Sale</p> },
    { key: "package balance", label: "Package Balance", content: <p>Package Balance.</p> },
    { key: "outstanding invoice", label: "Outstanding Invoice", content: <p>outstanding invoice.</p> },
    { key: "add prepaid card", label: "Add prepaid Card", content: <p>Add Prepaid card.</p> },
    { key: "gift card", label: "Gift Card", content: <p>Gift Card.</p> },
    { key: "gift card redeem", label: "Gift Card Redeem", content: <p>gift card redeem</p> },
    { key: "pre-paid card", label: "Prepaid Card", content: <p>Prepaid Card.</p> },
    { key: "rewards point", label: "Rewards Point", content: <p>Rewards point</p> },
    { key: "advance_amount", label: "Advance Amount", content: <AdvancePayment client={client} /> },
    { key: "New Visit Discount", label: "New Visit Discount", content: <p>New Visit Discount</p> },
    { key: "Secondary Client", label: "Secondary Client", content: <p>Secondary Client</p> },
  ];
